            ...
            <form id="areaEditForm" method="POST" action="#">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 form-group-validation">
                        ...
                        <input type="text" name="name" id="edit-area-name" class="form-control">
                        <span class="field-error text-danger small" id="edit-area-name-error"></span>
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="updateAreaBtn" class="btn btn-primary px-4"
                        style="height: 48px; border-radius: 10px; font-weight: 600;">
                        Update
                    </button>
                </div>
